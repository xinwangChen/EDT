...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        if self.local:
            self.modulation_matrix = modulation_matrix(input_resolution,2*input_resolution).unsqueeze(0).unsqueeze(0)
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        for i in range(depth):
            self.blocks.append(DiTBlock(hidden_size, num_heads, mlp_ratio=mlp_ratio, local=False, input_resolution=input_resolution))
